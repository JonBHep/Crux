...
public partial class CardsWindow : Window
{
    private readonly Cartes _cartes;
        ...
        private void DisplayList()
        {
            ...
            {
                TextBlock bloc = new TextBlock() { Text = cb.Caption, FontFamily=new FontFamily("Lucida Console"), FontSize=12, Foreground=Brushes.SaddleBrown };
...
CardEditor w = new CardEditor(s) { Owner = this };
        ...
        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBoxResult ans = MessageBox.Show($"Delete the card {cap}", Jbh.AppManager.AppName, MessageBoxButton.YesNo, MessageBoxImage.Question);
