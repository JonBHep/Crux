...
public class MotList
{
    ...
    internal Mot MotForName(string nom)
    {
        return _jFiles[MotDictionary[nom]];
    }
    ...
    public static bool IsPermittedString(string proposed)
    {
        ...
        if (proposed.Contains(Pairconnector))
        {
            rv = false;
        }
    ...
    {
        // Purge oldest backup files if there are more than 49
        ...
        while (foundfiles.Count() > 50) // current data plus 49 backups
        {
